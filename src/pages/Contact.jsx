...
export const Contact = () => {
  return (
    <div className="contact">
      <Heading title="Contact us" data-aos="fade-down"/>
      <div className="container py-4 blur-box">
        <div className="row align-items-center">
          ...
          <div className="col-lg-6 text-light contact-info">
            ...
            <hr />
            <p className="email" data-aos="fade-up-right">
            ...
            <hr />
            <p className="facebook" data-aos="fade-up-left">
            ...
            <hr />
            <p className="website" data-aos="fade-up-right">
          ...
          <div className="col-lg-6 map-info">
            ...
            <div className="map-container" data-aos="flip-left">
              <iframe 
